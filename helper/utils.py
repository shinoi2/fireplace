...
SOLVED_KEYWORDS = [
    ...
    r"Spell Damage \+\d+",
    r"Arcane Spell Damage \+\d+",
    r"Fire Spell Damage \+\d+",
    r"Frost Spell Damage \+\d+",
    r"Nature Spell Damage \+\d+",
    r"Holy Spell Damage \+\d+",
    r"Shadow Spell Damage \+\d+",
    r"Fel Spell Damage \+\d+",
