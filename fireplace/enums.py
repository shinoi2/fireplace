...
DISCARDED = -14
CAST_ON_FRIENDLY_MINIONS = -15
UNLIMITED_ATTACKS = -16
ELEMENTAL_PLAYED_LAST_TURN = -17
HEROPOWER_DISABLED = -18
EXTRA_END_TURN_EFFECT = -19
PASSIVE_HERO_POWER = -20
KEEP_BUFF = -21
DAMAGED_THIS_TURN = -22
MINION_EXTRA_COMBOS = -23
MINION_EXTRA_BATTLECRIES = -24
EXTRA_TRIGGER_SECRET = -25
CAST_ON_FRIENDLY_CHARACTERS = -26
CUSTOM_CARDTEXT = -27
ACTIVATIONS_THIS_TURN = -28
HERO_HEALTH_CHANGED_THIS_TURN = -29
TEMPORARY = -30
INCOMING_DAMAGE_MULTIPLIER_FROM_SPELL = -31
HEALED_THIS_TURN = -32
NUM_HERO_ATTACKS_THIS_GAME = -33
DAMAGED_ON_OPPONENT_TURN = -34
...
class PlayReq(IntEnum):
    ...
    REQ_MAX_QUESTS = 64
    REQ_TARGET_IF_AVAILABLE_AND_ELEMENTAL_PLAYED_LAST_TURN = 65
    ...
    REQ_TARGET_IF_AVAILABLE_AND_DECK_LESS_OR_EQUAL = 144
    REQ_TARGET_IF_AVAILABLE_AND_CONTROLLER_OTHER_WITH_RACE = 145
    REQ_TARGET_IF_AVAILABLE_AND_WEAPON_EQUIPPED = 146
