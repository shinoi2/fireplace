...
class PlayerManager(Manager):
    map = {
        ...
        GameTag.SPELLPOWER_ARCANE: "spellpower_arcane",
        GameTag.SPELLPOWER_FIRE: "spellpower_fire",
        GameTag.SPELLPOWER_FROST: "spellpower_frost",
        GameTag.SPELLPOWER_NATURE: "spellpower_nature",
        GameTag.SPELLPOWER_HOLY: "spellpower_holy",
        GameTag.SPELLPOWER_SHADOW: "spellpower_shadow",
        GameTag.SPELLPOWER_FEL: "spellpower_fel",
        GameTag.SPELLPOWER_PHYSICAL: "spellpower_physical",
        ...
        enums.NUM_HERO_ATTACKS_THIS_GAME: "hero_attacks_this_game",
        GameTag.NUM_SPELLS_PLAYED_THIS_GAME: "spells_played_this_game",
        ...
        GameTag.ARMOR_GAINED_THIS_GAME: "armor_gained_this_game",
...
CARD_ATTRIBUTE_MAP = {
    ...
    GameTag.CARDTYPE: "type",
    GameTag.CASTS_WHEN_DRAWN: "casts_when_drawn",
    ...
    GameTag.CORRUPTED_CARD: "corrupted_card",
    GameTag.COST: "cost",
    ...
    GameTag.SPELLS_CAST_TWICE: "spells_cast_twice",
    ...
    GameTag.TAG_SCRIPT_DATA_NUM_1: "data_num_1",
    GameTag.TAG_SCRIPT_DATA_NUM_2: "data_num_2",
    GameTag.FRENZY: "has_frenzy",
    ...
    enums.DAMAGED_ON_OPPONENT_TURN: "damaged_on_opponent_turn",
